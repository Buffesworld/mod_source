...
package net.mcreator.buffesworld.entity;
...
public class PurplecowEntity extends BuffesWorldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.4f)).build("purplecow").setRegistryName("purplecow");
	public PurplecowEntity(BuffesWorldModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PurplecowRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("buffes_world:mysticalforest").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
