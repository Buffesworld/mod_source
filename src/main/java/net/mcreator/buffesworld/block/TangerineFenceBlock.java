...
public class TangerineFenceBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_fence")
	public static final Block block = null;
	public TangerineFenceBlock(BuffesWorldModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("tangerine_fence");
		}
