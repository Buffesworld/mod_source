...
public class PurplePlanksBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:purple_planks")
	public static final Block block = null;
	public PurplePlanksBlock(BuffesWorldModElements instance) {
		super(instance, 21);
	}
