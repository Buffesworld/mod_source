...
public class TangerineSlabBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_slab")
	public static final Block block = null;
	public TangerineSlabBlock(BuffesWorldModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tangerine_slab");
		}
