...
public class PurpleFenceBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:purple_fence")
	public static final Block block = null;
	public PurpleFenceBlock(BuffesWorldModElements instance) {
		super(instance, 25);
	}
