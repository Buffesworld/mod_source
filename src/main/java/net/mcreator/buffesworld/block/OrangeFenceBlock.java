...
public class OrangeFenceBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:orange_fence")
	public static final Block block = null;
	public OrangeFenceBlock(BuffesWorldModElements instance) {
		super(instance, 7);
	}
