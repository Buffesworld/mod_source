...
public class TangerineStairsBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_stairs")
	public static final Block block = null;
	public TangerineStairsBlock(BuffesWorldModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tangerine_stairs");
		}
