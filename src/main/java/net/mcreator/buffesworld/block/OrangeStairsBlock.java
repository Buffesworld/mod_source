...
public class OrangeStairsBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:orange_stairs")
	public static final Block block = null;
	public OrangeStairsBlock(BuffesWorldModElements instance) {
		super(instance, 5);
	}
