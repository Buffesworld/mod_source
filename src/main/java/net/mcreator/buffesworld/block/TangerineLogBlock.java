...
public class TangerineLogBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_log")
	public static final Block block = null;
	public TangerineLogBlock(BuffesWorldModElements instance) {
		super(instance, 55);
	}
