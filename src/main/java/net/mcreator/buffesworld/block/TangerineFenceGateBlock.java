...
public class TangerineFenceGateBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_fence_gate")
	public static final Block block = null;
	public TangerineFenceGateBlock(BuffesWorldModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("tangerine_fence_gate");
		}
