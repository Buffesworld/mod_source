...
public class OrangeLogBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:orange_log")
	public static final Block block = null;
	public OrangeLogBlock(BuffesWorldModElements instance) {
		super(instance, 2);
	}
