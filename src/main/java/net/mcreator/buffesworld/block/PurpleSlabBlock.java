...
public class PurpleSlabBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:purple_slab")
	public static final Block block = null;
	public PurpleSlabBlock(BuffesWorldModElements instance) {
		super(instance, 24);
	}
