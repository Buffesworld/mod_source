...
public class OrangeFenceGateBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:orange_fence_gate")
	public static final Block block = null;
	public OrangeFenceGateBlock(BuffesWorldModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_fence_gate");
		}
