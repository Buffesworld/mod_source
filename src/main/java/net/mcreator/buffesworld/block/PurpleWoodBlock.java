...
public class PurpleWoodBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:purple_wood")
	public static final Block block = null;
	public PurpleWoodBlock(BuffesWorldModElements instance) {
		super(instance, 19);
	}
