...
public class TangerineWoodBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_wood")
	public static final Block block = null;
	public TangerineWoodBlock(BuffesWorldModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tangerine_wood");
		}
