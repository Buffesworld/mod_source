...
public class TangerinePlanksBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_planks")
	public static final Block block = null;
	public TangerinePlanksBlock(BuffesWorldModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tangerine_planks");
		}
