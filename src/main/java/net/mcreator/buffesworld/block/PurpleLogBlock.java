...
public class PurpleLogBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:purple_log")
	public static final Block block = null;
	public PurpleLogBlock(BuffesWorldModElements instance) {
		super(instance, 20);
	}
