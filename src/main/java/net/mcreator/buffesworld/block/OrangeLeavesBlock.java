...
public class OrangeLeavesBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:orange_leaves")
	public static final Block block = null;
	public OrangeLeavesBlock(BuffesWorldModElements instance) {
		super(instance, 4);
	}
