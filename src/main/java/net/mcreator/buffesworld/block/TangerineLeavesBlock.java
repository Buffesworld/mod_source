...
public class TangerineLeavesBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:tangerine_leaves")
	public static final Block block = null;
	public TangerineLeavesBlock(BuffesWorldModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tangerine_leaves");
		}
