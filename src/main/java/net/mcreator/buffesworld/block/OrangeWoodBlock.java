...
public class OrangeWoodBlock extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:orange_wood")
	public static final Block block = null;
	public OrangeWoodBlock(BuffesWorldModElements instance) {
		super(instance, 1);
	}
