...
public class CitrinejewelItem extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:citrinejewel")
	public static final Item block = null;
	public CitrinejewelItem(BuffesWorldModElements instance) {
		super(instance, 43);
	}
