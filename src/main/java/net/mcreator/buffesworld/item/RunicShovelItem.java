...
public class RunicShovelItem extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:runic_shovel")
	public static final Item block = null;
	public RunicShovelItem(BuffesWorldModElements instance) {
		super(instance, 82);
	}
