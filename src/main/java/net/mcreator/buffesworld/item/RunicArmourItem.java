...
public class RunicArmourItem extends BuffesWorldModElements.ModElement {
	@ObjectHolder("buffes_world:runic_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("buffes_world:runic_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("buffes_world:runic_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("buffes_world:runic_armour_boots")
	public static final Item boots = null;
	public RunicArmourItem(BuffesWorldModElements instance) {
		super(instance, 72);
	}
