...
package net.mcreator.buffesworld.world.biome;
...
import net.mcreator.buffesworld.block.OrangeLogBlock;
...
public class OrangewoodforestBiome extends BuffesWorldModElements.ModElement {
	public static Biome biome;
	public OrangewoodforestBiome(BuffesWorldModElements instance) {
		super(instance, 17);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OrangeLogBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("buffes_world:orangewoodforest"));
			}
		}
	}
	@Override
